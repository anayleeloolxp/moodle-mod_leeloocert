...
/**
 * AMD module used when rearranging a leeloo certificate.
 *
 * @module     mod_leeloocert/rearrange-area
...
define([
  ...
  RearrangeArea.prototype._editElement = function (event) {
    ...
    fragment
      .loadFragment("mod_leeloocert", "editelement", contextid, params)
      .done(
        function (html, js) {
          str.get_string("editelement", "mod_leeloocert").done(
            function (title) {
              Y.use(
                ...
                function () {
                  new Dialogue(
                    ...
                    this._editElementDialogueConfig.bind(
                      this,
                      elementid,
                      html,
                      js
  ...
  RearrangeArea.prototype._editElementDialogueConfig = function (
    elementid,
    html,
    js,
    popup
    ...
    body.on(
      ...
      function (e) {
        ...
        // Save the data.
        this._saveElement(elementid)
          .then(
            function () {
              // Update the DOM to reflect the adjusted value.
              this._getElementHTML(elementid).done(
                function (html) {
  ...
  RearrangeArea.prototype._setPosition = function (
    elementid,
    refpoint,
    posx,
    posy
  ...
  RearrangeArea.prototype._getElementHTML = function (elementid) {
    ...
    var promises = ajax.call([
      {
        methodname: "mod_leeloocert_get_element_html",
        args: {
  ...
  RearrangeArea.prototype._saveElement = function (elementid) {
    ...
    var promises = ajax.call([
      {
        methodname: "mod_leeloocert_save_element",
        args: {
          templateid: templateid,
          elementid: elementid,
          values: inputs,
