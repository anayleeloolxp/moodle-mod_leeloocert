YUI.add(
  ...
  function (Y, NAME) {
    /**
     * Rearrange elements in the leeloo certificate
     *
     * @class Y.M.mod_leeloocert.rearrange
     * @constructor
     */
    ...
    Y.extend(Rearrange, Y.Base, {
      ...
      /**
       * The leeloocert page we are displaying.
       */
      page: [],

      /**
       * The leeloo certificate elements to display.
       */
      elements: [],
      ...
      setpositions: function () {
        ...
        for (var key in this.elements) {
          ...
          var nodewidth = parseFloat(
            Y.one("#element-" + element.id).getComputedStyle("width")
          );
      ...
      createevents: function () {
        ...
        Y.one(".savepositionsbtn [type=submit]").on(
          "click",
          function (e) {
        ...
        Y.one(".applypositionsbtn [type=submit]").on(
          "click",
          function (e) {
            this.savepositions(e);
            e.preventDefault();
      ...
      savepositions: function (e) {
        ...
        Y.io(M.cfg.wwwroot + "/mod/leeloocert/ajax.php", {
          method: "POST",
          data: params,
          on: {
    ...
    Y.namespace("M.mod_leeloocert.rearrange").init = function (
      templateid,
      page,
      elements
    ) {
