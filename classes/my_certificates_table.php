...
class my_certificates_table extends \table_sql {
    ...
    public function __construct($userid, $download = null) {
        ...
        $headers = array(
            get_string('name'),
            get_string('course'),
            get_string('receiveddate', 'leeloolxpcert'),
            get_string('code', 'leeloolxpcert')
        );
    ...
    public function col_name($certificate) {
        $cm = get_coursemodule_from_instance('leeloolxpcert', $certificate->id);
    ...
    public function col_download($certificate) {
        ...
        $link = new \moodle_url(
            '/mod/leeloolxpcert/my_certificates.php',
            array(
                'userid' => $this->userid,
