...
class renderer extends plugin_renderer_base {
     ...
     * Defer to template.
     *
     * @param \mod_leeloocert\output\verify_certificate_results $page
     * @return string html for the page
     */
    public function render_verify_certificate_results(verify_certificate_results $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('mod_leeloocert/verify_certificate_results', $data);
    }
    ...
    public function render_email_certificate(email_certificate $certificate) {
        ...
        return $this->render_from_template('mod_leeloocert/' . $this->get_template_name(), $data);
    }
}
