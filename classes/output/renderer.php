...
class renderer extends plugin_renderer_base {
     ...
     * @param \mod_leeloolxpcert\output\verify_certificate_results $page
    ...
    public function render_verify_certificate_results(verify_certificate_results $page) {
        ...
        return parent::render_from_template('mod_leeloolxpcert/verify_certificate_results', $data);
    }
    ...
    public function render_email_certificate(email_certificate $certificate) {
        ...
        return $this->render_from_template('mod_leeloolxpcert/' . $this->get_template_name(), $data);
    }
}
