...
class verify_certificate_form extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'code', get_string('code', 'leeloocert'));
        $mform->setType('code', PARAM_ALPHANUM);

        $mform->addElement('submit', 'verify', get_string('verify', 'leeloocert'));
    }
    ...
    public function validation($data, $files) {
        ...
        if ($data['code'] === '') {
            $errors['code'] = get_string('invalidcode', 'leeloocert');
        }
