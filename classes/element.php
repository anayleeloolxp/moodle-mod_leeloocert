...
/**
 * The base class for the leeloocert elements.
 *
 ...
 * Class element
 *
 * All leeloocert element plugins are based on this class.
 *
 * @package    mod_leeloocert
 * @copyright  2013 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
abstract class element {
    ...
    public function save_form_elements($data) {
        ...
        if (!empty($this->id)) { // Must be updating a record in the database.
            $element->id = $this->id;
            return $DB->update_record('leeloocert_elements', $element);
            ...
            return $DB->insert_record('leeloocert_elements', $element, false);
        }
    }
    ...
    public function delete() {
        ...
        return $DB->delete_records('leeloocert_elements', array('id' => $this->id));
    }
    ...
    /**
     * Set edit form instance for the leeloo cert element.
     *
     * @param \mod_leeloocert\edit_element_form $editelementform
     */
    ...
    /**
     * Get edit form instance for the leeloo cert element.
     *
     * @return \mod_leeloocert\edit_element_form
     */
