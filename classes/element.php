...
/**
 * The base class for the leeloolxpcert elements.
 *
 ...
 * Class element
 *
 * All leeloolxpcert element plugins are based on this class.
 *
 * @package    mod_leeloolxpcert
 * @copyright  2013 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
abstract class element {
    ...
    public function __construct($element) {
        $showposxy = get_config('leeloolxpcert', 'showposxy');
    ...
    public function save_form_elements($data) {
        ...
        if (!empty($this->id)) { // Must be updating a record in the database.
            $element->id = $this->id;
            return $DB->update_record('leeloolxpcert_elements', $element);
        } else { // Must be adding a new one.
            $element->element = $data->element;
            $element->pageid = $data->pageid;
            $element->sequence = \mod_leeloolxpcert\element_helper::get_element_sequence($element->pageid);
            $element->timecreated = time();
            return $DB->insert_record('leeloolxpcert_elements', $element, false);
        }
    }
    ...
    public function delete() {
        ...
        return $DB->delete_records('leeloolxpcert_elements', array('id' => $this->id));
    }
     ...
     *
     * @param \mod_leeloolxpcert\edit_element_form $editelementform
     */
     ...
     *
     * @return \mod_leeloolxpcert\edit_element_form
     */
