...
class manage_templates_table extends \table_sql {
    ...
    public function __construct($context) {
        parent::__construct('mod_leeloolxpcert_manage_templates_table');
    ...
    public function col_actions($template) {
        ...
        $editlink = new \moodle_url('/mod/leeloolxpcert/edit.php', array('tid' => $template->id));
        ...
        $duplicatelink = new \moodle_url(
            '/mod/leeloolxpcert/manage_templates.php',
            array(
                'tid' => $template->id,
                'action' => 'duplicate',
                'sesskey' => sesskey()
    ...
    public function query_db($pagesize, $useinitialsbar = true) {
        ...
        $total = $DB->count_records('leeloolxpcert_templates', array('contextid' => $this->context->id));
