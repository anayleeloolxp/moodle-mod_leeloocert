...
Feature: Being able to manage elements in a certificate template
  ...
  Scenario: Add and edit elements in a certificate template
    # Background image.
    And I add the element "Background image" to page "1" of the "Leeloo certificate 1" certificate template
    And I press "Save changes"
    And I should see "Background image" in the "elementstable" "table"
    # Border.
    And I add the element "Border" to page "1" of the "Leeloo certificate 1" certificate template
    ...
    And I press "Save changes"
    # Category name.
    And I add the element "Category name" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Font                     | Helvetica |
      | Size                     | 20        |
      | Colour                   | #045ECD   |
    ...
    And I press "Save changes"
    # Code.
    And I add the element "Code" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Font                     | Helvetica |
      | Size                     | 20        |
      | Colour                   | #045ECD   |
    ...
    And I press "Save changes"
    # Course field.
    And I add the element "Course field" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Font                     | Helvetica |
      | Size                     | 20        |
      | Colour                   | #045ECD   |
    ...
    And I press "Save changes"
    # Course name.
    And I add the element "Course name" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Font                     | Helvetica |
      | Size                     | 20        |
      | Colour                   | #045ECD   |
    ...
    And I press "Save changes"
    # Date.
    And I add the element "Date" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
    ...
    And I press "Save changes"
    # Date range.
    And I add the element "Date range" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Date item                | Course start date    |
      | Font                     | Helvetica            |
      | Size                     | 20                   |
    ...
    And I press "Save changes"
    # Digital signature.
    And I add the element "Digital signature" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
    ...
    And I press "Save changes"
    # Grade.
    And I add the element "Grade" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
    ...
    And I press "Save changes"
    # Grade item name.
    And I add the element "Grade item name" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
    ...
    And I press "Save changes"
    # Image.
    And I add the element "Image" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Width         | 25  |
      | Height        | 15  |
      | Alpha channel | 0.7 |
    ...
    And I press "Save changes"
    # Student name.
    And I add the element "Student name" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Font                     | Helvetica |
      | Size                     | 20        |
      | Colour                   | #045ECD   |
    ...
    And I press "Save changes"
    # Teacher name.
    And I add the element "Teacher name" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Teacher                  | Teacher 2 |
      | Font                     | Helvetica |
      | Size                     | 20        |
    ...
    And I press "Save changes"
    # Text.
    And I add the element "Text" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Text                     | Test this |
      | Font                     | Helvetica |
      | Size                     | 20        |
    ...
    And I press "Save changes"
    # User field.
    And I add the element "User field" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | User field               | Country   |
      | Font                     | Helvetica |
      | Size                     | 20        |
    ...
    And I press "Save changes"
    # User picture.
    And I add the element "User picture" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Width  | 10 |
      | Height | 10 |
    And I press "Save changes"
    ...
    And I press "Save changes"
    # QR Code.
    And I add the element "QR code" to page "1" of the "Leeloo certificate 1" certificate template
    And I set the following fields to these values:
      | Width         | 25  |
      | Height        | 15  |
    And I press "Save changes"
