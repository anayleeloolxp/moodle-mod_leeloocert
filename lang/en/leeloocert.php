...
/**
 * Language strings for the leeloocert module.
 *
...
$string['leeloocert:addinstance'] = 'Add a new leeloo certificate instance';
$string['leeloocert:manage'] = 'Manage a leeloo certificate';
$string['leeloocert:manageemailstudents'] = 'Manage email students setting';
...
$string['leeloocert:manageverifyany'] = 'Manage verification setting';
$string['leeloocert:managerequiredtime'] = 'Manage time required setting';
$string['leeloocert:manageprotection'] = 'Manage protection setting';
$string['leeloocert:receiveissue'] = 'Receive a certificate';
$string['leeloocert:view'] = 'View a leeloo certificate';
$string['leeloocert:viewreport'] = 'View course report';
$string['leeloocert:viewallcertificates'] = 'View all certificates';
$string['leeloocert:verifyallcertificates'] = 'Verify all certificates on the site';
$string['leeloocert:verifycertificate'] = 'Verify a certificate';
$string['leeloocertsettings'] = 'Leeloo certificate settings';
...
$string['editleeloocert'] = 'Edit certificate';
...
$string['getleeloocert'] = 'View certificate';
...
$string['noleeloocerts'] = 'There are no certificates for this course';
...
$string['print'] = 'Print';
$string['privacy:metadata:leeloocert_issues'] = 'The list of issued certificates';
$string['privacy:metadata:leeloocert_issues:code'] = 'The code that belongs to the certificate';
$string['privacy:metadata:leeloocert_issues:leeloocertid'] = 'The ID of the certificate';
$string['privacy:metadata:leeloocert_issues:emailed'] = 'Whether or not the certificate was emailed';
$string['privacy:metadata:leeloocert_issues:timecreated'] = 'The time the certificate was issued';
$string['privacy:metadata:leeloocert_issues:userid'] = 'The ID of the user who was issued the certificate';
