 ...
 * Language strings for the leeloolxpcert module.
...
$string['leeloolxpcert:addinstance'] = 'Add a new leeloo certificate instance';


$string['leeloolxpcert:manage'] = 'Manage a leeloo certificate';


$string['leeloolxpcert:manageemailstudents'] = 'Manage email students setting';


$string['leeloolxpcert:manageemailteachers'] = 'Manage email teachers setting';


$string['leeloolxpcert:manageemailothers'] = 'Manage email others setting';


$string['leeloolxpcert:managecertificatevalidthru'] = 'Manage certificate valid thru others setting';


$string['leeloolxpcert:managelicense'] = 'Leeloo LXP License ID';
...
$string['leeloolxpcert:manageverifyany'] = 'Manage verification setting';


$string['leeloolxpcert:managerequiredtime'] = 'Manage time required setting';


$string['leeloolxpcert:manageprotection'] = 'Manage protection setting';


$string['leeloolxpcert:receiveissue'] = 'Receive a certificate';


$string['leeloolxpcert:view'] = 'View a leeloo certificate';


$string['leeloolxpcert:viewreport'] = 'View course report';


$string['leeloolxpcert:viewallcertificates'] = 'View all certificates';


$string['leeloolxpcert:verifyallcertificates'] = 'Verify all certificates on the site';


$string['leeloolxpcert:verifycertificate'] = 'Verify a certificate';


$string['leeloolxpcertsettings'] = 'Leeloo certificate settings';
...
$string['editleeloolxpcert'] = 'Edit certificate';
...
$string['certificatevalidthru'] = 'Certificate valid thru (in months)';


$string['gdrivejsonfile'] = 'Google drive json file';


$string['folderid'] = 'Folder Id';


$string['uploadondrive'] = 'Upload on google drive';
...
$string['certificatevalidthru_help'] = 'If set this will email the email addresses listed here (separated by a comma) with a copy of the certificate when it becomes available. <strong>Warning:</strong> Setting this field before you have finished creating the certificate will email the addresses an incomplete certificate.';


$string['gdrivejsonfile_help'] = 'Paste here the json file content of google drive service account.';


$string['folderid_help'] = 'Paste here the google drive folder id where you want to upload certificates.';


$string['uploadondrive_desc'] = 'Check this if you want to upload the certificate on google drive.';
...
$string['getleeloolxpcert'] = 'View certificate';
...
$string['managetemplatesdesc'] = 'This link will take you to a new screen where you will be able to manage templates used by Leeloo certificate activities in courses.';


$string['modify'] = 'Modify';


$string['modulename'] = 'Leeloo certificate';


$string['modulenameplural'] = 'Leeloo certificates';


$string['modulename_help'] = 'This module allows for the dynamic generation of PDF certificates.';


$string['modulename_link'] = 'Leeloo_certificate_module';
...
$string['noleeloolxpcerts'] = 'There are no certificates for this course';
...
$string['pluginadministration'] = 'Leeloo certificate administration';


$string['pluginname'] = 'Leeloo certificate';
...
$string['privacy:metadata:leeloolxpcert_issues'] = 'The list of issued certificates';


$string['privacy:metadata:leeloolxpcert_issues:code'] = 'The code that belongs to the certificate';


$string['privacy:metadata:leeloolxpcert_issues:leeloolxpcertid'] = 'The ID of the certificate';


$string['privacy:metadata:leeloolxpcert_issues:emailed'] = 'Whether or not the certificate was emailed';


$string['privacy:metadata:leeloolxpcert_issues:timecreated'] = 'The time the certificate was issued';


$string['privacy:metadata:leeloolxpcert_issues:userid'] = 'The ID of the user who was issued the certificate';
...
$string['search:activity'] = 'Leeloo certificate - activity information';
