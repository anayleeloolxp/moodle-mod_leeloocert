...
/**
 * Handles AJAX requests for the leeloolxpcert module.
 *
...
$template = $DB->get_record('leeloolxpcert_templates', array('id' => $tid), '*', MUST_EXIST);
...
foreach ($values as $value) {
    ...
    $DB->update_record('leeloolxpcert_elements', $element);
}
