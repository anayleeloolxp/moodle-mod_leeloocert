...
/**
 * This file contains the leeloocert element coursename's core interaction API.
 *
 * @package    leeloocertelement_coursename
 * @copyright  2013 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace leeloocertelement_coursename;

defined('MOODLE_INTERNAL') || die();

/**
 * The leeloocert element coursename's core interaction API.
 *
 * @package    leeloocertelement_coursename
 * @copyright  2013 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class element extends \mod_leeloocert\element {
    ...
    public function render($pdf, $preview, $user) {
        \mod_leeloocert\element_helper::render_content($pdf, $this, $this->get_course_name());
    }
    ...
    public function render_html() {
        return \mod_leeloocert\element_helper::render_html_content($this, $this->get_course_name());
    }
