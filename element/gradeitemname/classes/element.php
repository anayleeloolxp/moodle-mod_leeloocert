...
/**
 * This file contains the leeloocert element gradeitemname's core interaction API.
 *
 * @package    leeloocertelement_gradeitemname
 * @copyright  2013 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace leeloocertelement_gradeitemname;

defined('MOODLE_INTERNAL') || die();

/**
 * The leeloocert element gradeitemname's core interaction API.
 *
 * @package    leeloocertelement_gradeitemname
 * @copyright  2013 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class element extends \mod_leeloocert\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('select', 'gradeitem', get_string('gradeitem', 'leeloocertelement_gradeitemname'),
            \mod_leeloocert\element_helper::get_grade_items($COURSE));
        $mform->addHelpButton('gradeitem', 'gradeitem', 'leeloocertelement_gradeitemname');
    ...
    public function render($pdf, $preview, $user) {
        ...
        if (!empty($this->get_data())) {
            \mod_leeloocert\element_helper::render_content($pdf, $this, $this->get_grade_item_name());
        }
    }
    ...
    public function render_html() {
        // Check that the grade item is not empty.
        if (!empty($this->get_data())) {
            return \mod_leeloocert\element_helper::render_html_content($this, $this->get_grade_item_name());
        }
