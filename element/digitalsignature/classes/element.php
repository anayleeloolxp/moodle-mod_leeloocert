...
/**
 * This file contains the leeloocert element digitial signature's core interaction API.
 *
 * @package    leeloocertelement_digitalsignature
 * @copyright  2017 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace leeloocertelement_digitalsignature;

defined('MOODLE_INTERNAL') || die();

/**
 * The leeloocert element digital signature's core interaction API.
 *
 * @package    leeloocertelement_digitalsignature
 * @copyright  2017 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class element extends \leeloocertelement_image\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('text', 'signaturelocation', get_string('signaturelocation', 'leeloocertelement_digitalsignature'));
        $mform->setType('signaturelocation', PARAM_TEXT);
        $mform->setDefault('signaturelocation', '');

        $mform->addElement('text', 'signaturereason', get_string('signaturereason', 'leeloocertelement_digitalsignature'));
    ...
    public function save_form_elements($data) {
        ...
        \mod_leeloocert\certificate::upload_files($data->digitalsignature, $context->id, 'signature');
    ...
    public static function get_signatures() {
        ...
        $arrfiles = array('0' => get_string('nosignature', 'leeloocertelement_digitalsignature')) + $arrfiles;
