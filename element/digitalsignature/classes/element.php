...
/**
 * This file contains the leeloolxpcert element digitial signature's core interaction API.
 *
 * @package    leeloolxpcertelement_digitalsignature
 * @copyright  2017 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace leeloolxpcertelement_digitalsignature;

defined('MOODLE_INTERNAL') || die();

/**
 * The leeloolxpcert element digital signature's core interaction API.
 *
 * @package    leeloolxpcertelement_digitalsignature
 * @copyright  2017 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class element extends \leeloolxpcertelement_image\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement(
            'select',
            'signaturefileid',
            get_string('digitalsignature', 'leeloolxpcertelement_digitalsignature'),
            self::get_signatures()
        );

        $mform->addElement('text', 'signaturename', get_string('signaturename', 'leeloolxpcertelement_digitalsignature'));
        ...
        $mform->addElement(
            'passwordunmask',
            'signaturepassword',
            get_string('signaturepassword', 'leeloolxpcertelement_digitalsignature')
        );
        $mform->setType('signaturepassword', PARAM_TEXT);
        $mform->setDefault('signaturepassword', '');

        $mform->addElement('text', 'signaturelocation', get_string('signaturelocation', 'leeloolxpcertelement_digitalsignature'));
        $mform->setType('signaturelocation', PARAM_TEXT);
        $mform->setDefault('signaturelocation', '');

        $mform->addElement('text', 'signaturereason', get_string('signaturereason', 'leeloolxpcertelement_digitalsignature'));
        ...
        $mform->addElement(
            ...
            get_string('signaturecontactinfo', 'leeloolxpcertelement_digitalsignature')
        );
        ...
        $mform->addElement(
            'filemanager',
            'digitalsignature',
            get_string('uploaddigitalsignature', 'leeloolxpcertelement_digitalsignature'),
            '',
            $this->signaturefilemanageroptions
        );
    }
    ...
    public function save_form_elements($data) {
        ...
        \mod_leeloolxpcert\certificate::upload_files($data->digitalsignature, $context->id, 'signature');
    ...
    public static function get_signatures() {
        ...
        $arrfiles = array('0' => get_string('nosignature', 'leeloolxpcertelement_digitalsignature')) + $arrfiles;
