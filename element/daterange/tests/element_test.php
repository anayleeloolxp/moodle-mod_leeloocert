...
require_once($CFG->dirroot . '/mod/leeloolxpcert/element/daterange/tests/fixtures/fake_datarange_element.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class leeloolxpcertelement_daterange_element_test extends advanced_testcase {
